...
AppRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            { provide: _angular_common__WEBPACK_IMPORTED_MODULE_5__["APP_BASE_HREF"], useValue: '/' + (window.location.pathname.split('/')[1] || '') }
        ]
    })
], AppRoutingModule);
...
let CategoriesConfigComponent = class CategoriesConfigComponent {
    ...
    onAdd(f) {
        const category = new _models_category_model__WEBPACK_IMPORTED_MODULE_3__["Category"](f.value.name, null);
        this.categories.push(category);
        this.categoriesOutput.emit(category);
        f.reset();
    }
};
CategoriesConfigComponent.ctorParameters = () => [
...
let SettingsComponent = class SettingsComponent {
    ...
    onSave() {
        this.sectionsService.addCategory(this.categories).subscribe((data) => {
            this.categories = [];
        });
    }
};
...
let ContentPanelComponent = class ContentPanelComponent {
    constructor(activatedRoute, sectionsService) {
    ...
    ngOnInit() {
        this.activatedRoute.params.subscribe((params) => {
            this.sectionsService.getCategory(params.category).subscribe(((category) => {
...
let SectionsService = class SectionsService {
    ...
    getCategories() {
        return this.http.get(`${this._ENDPOINT}/categories`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
            const categories = [];
    ...
    getCategory(techName) {
        return this.http.get(`${this._ENDPOINT}/categories/${techName}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
